...
class EducationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post educations_url, params: { education: { degree: @education.degree, gpa: @education.gpa, major: @education.major, school: @education.school, time: @education.time } }
    end
  ...
  test "should update education" do
    patch education_url(@education), params: { education: { degree: @education.degree, gpa: @education.gpa, major: @education.major, school: @education.school, time: @education.time } }
